...
import { applyModelConfigToSession, buildSessionModelChange, ensureSharedPiAuth, mergeConfig, resolveModel, resolvePiAgentDir, } from "./config.js";
const OPENAI = "openai";
...
void test("higher-precedence flat phase model overrides inherited preset model", () => {
    const merged = mergeConfig(makeConfig({
        models: {
            "review-first": preset({
