/**
 * Global type declarations for the pi runtime environment.
 * pi runs code via Bun, which provides CJS globals even in ESM mode.
 */

// Bun/pi provides __dirname as a global in ESM
...
declare module "@earendil-works/pi-coding-agent" {
  interface ExtensionAPI {
    ...
    registerTool: (tool: {
      ...
      parameters: unknown;
      execute: (toolCallId: string, params: Record<string, unknown>) => ToolResult | Promise<ToolResult>;
    }) => void;
...
declare module "typebox" {
  export namespace Type {
    // The typebox API is used at runtime; these are loose stubs for
    // type-checking purposes.  The real shapes are validated by the
    // pi runtime.
